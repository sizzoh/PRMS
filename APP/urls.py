...
urlpatterns = [
    ...
    path('Query_appointment', views.Query_appointment, name='Query_appointment'),
    ...
    path('Accepted_appointments', views.Accepted_appointments, name='Accepted_appointments'),
    path('RejectedAppointment', views.RejectedAppointment, name='RejectedAppointment'),
    path('Query_AppointmentAccepted', views.Query_AppointmentAccepted, name='Query_AppointmentAccepted'),
    path('Query_AppointmentRejected', views.Query_AppointmentRejected, name='Query_AppointmentRejected'),
