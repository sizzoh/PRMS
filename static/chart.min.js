  ...
  function (t, e, i, r) {
    ...
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
      ...
      for (var h = t.length - 1; h >= 0; h--)
        (a = t[h]) && (o = (n < 3 ? a(o) : n > 3 ? a(e, i, o) : a(e, i)) || o);
...
let UIChart = class {
  ...
  onCanvasClick(t) {
    if (this.chart) {
      let e = this.chart.getElementAtEvent(t),
        i = this.chart.getDatasetAtEvent(t);
      e &&
        e[0] &&
        i &&
        this.onDataSelect.emit({ originalEvent: t, element: e[0], dataset: i });
    }
  }
  initChart() {
    let t = this.options || {};
  ...
  ngOnDestroy() {
    this.chart &&
      (this.chart.destroy(), (this.initialized = !1), (this.chart = null));
  }
};
